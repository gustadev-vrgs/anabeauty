...
export function TimeBlockModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-coffee-blackCoffee/45 px-3 py-2 backdrop-blur-sm sm:items-center sm:px-4 sm:py-8">
      <button type="button" aria-label="Fechar modal" className="absolute inset-0" onClick={onClose} />

      <section className="relative z-10 max-h-[96vh] w-full max-w-xl overflow-y-auto rounded-3xl border border-coffee-cappuccino bg-coffee-cream p-4 shadow-elevated sm:max-h-[88vh] sm:p-6">
