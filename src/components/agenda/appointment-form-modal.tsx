...
export function AppointmentFormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-coffee-blackCoffee/40 px-3 py-2 backdrop-blur-sm sm:items-center sm:px-4 sm:py-8">
      ...
      <section className="relative z-10 max-h-[95vh] w-full max-w-2xl overflow-y-auto rounded-3xl border border-coffee-cappuccino bg-coffee-cream p-4 shadow-elevated sm:max-h-[88vh] sm:p-6">
          ...
          <div className="space-y-1.5 sm:col-span-2">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <button
                ...
                className="rounded-lg border border-coffee-cappuccino bg-white px-3 py-1.5 text-xs font-semibold text-coffee-darkRoast transition hover:border-coffee-mocha hover:text-coffee-mocha"
              >
                + Nova cliente
              </button>
            </div>
