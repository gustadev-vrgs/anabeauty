...
export function MainLayout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen bg-[#f9f3ec] pb-24 md:pb-8">
      <div className="mx-auto flex w-full max-w-[1240px] flex-col gap-4 p-4 sm:p-6 md:flex-row md:items-start md:gap-6 md:p-6 lg:p-8">
        <AppSidebar />

        <div className="w-full space-y-4">
          <header className="sticky top-3 z-30 rounded-2xl border border-coffee-cappuccino/70 bg-coffee-latte/85 px-4 py-3 shadow-card backdrop-blur md:top-6 md:px-6">
